                ...
                foreach ($options as $option) {
                    ...
                    <div class="option">
                        ...
                        if ($option->type == 'facebook') { ?>
                            <input type="text" name="content[]" value="<?php echo $option->content; ?>" placeholder="http://facebook.com/your_profile"<br />
                        <?php } elseif ($option->type == 'instagram') { ?>
                            <input type="text" name="content[]" value="<?php echo $option->content; ?>" placeholder="http://instagram.com/your_profile"/><br />
                        <?php } elseif ($option->type == 'pinterest') { ?>
                            <input type="text" name="content[]" value="<?php echo $option->content; ?>" placeholder="http://pinterest.com/your_profile"/><br />
                        <?php } elseif ($option->type == 'address') { ?>
                            <textarea name="content[]" class="short" placeholder=""><?php echo $option->content; ?></textarea>
                        <?php } elseif ($option->type == 'hours') { ?>
                            <input type="text" name="content[]" value="<?php echo $option->content; ?>" placeholder="9am - 5pm">
                        <?php } elseif ($option->type == 'days') { ?>
